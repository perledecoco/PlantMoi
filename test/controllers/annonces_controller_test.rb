...
class AnnoncesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create annonce" do
    assert_difference('Annonce.count') do
      post annonces_url, params: { annonce: { description: @annonce.description, image: @annonce.image, localisation: @annonce.localisation, name: @annonce.name, title: @annonce.title } }
    end
  ...
  test "should update annonce" do
    patch annonce_url(@annonce), params: { annonce: { description: @annonce.description, image: @annonce.image, localisation: @annonce.localisation, name: @annonce.name, title: @annonce.title } }
